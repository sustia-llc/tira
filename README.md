...
*Figures below were generated by the current release (aif 0.10.0, 2026-07-17). The bandit
environment is unseeded ([issue #2](https://github.com/sustia-llc/tira/issues/2)), so the
exact scatter varies per regeneration — the reproduced claims are the qualitative shapes.*
