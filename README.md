...
*Figures below were generated by the current workspace (aif 0.11.0, 2026-07-18). Since the
seed-threading work ([issue #2](https://github.com/sustia-llc/tira/issues/2)) every run is
deterministic (master seed 2026): re-running `cargo run --release -p reproduce --bin reproduce`
