...
`aif-v0.5.0`; `aif-v0.8.0` is the current release — parity items #12 (multi-factor,
multi-modality, injectable B via `GenerativeModel`/`from_model`), #15 (opt-in marginal
message passing), #16 (surfaced F), and #13 (full pA/pB/pD/pE learning with η/ω, novelty
