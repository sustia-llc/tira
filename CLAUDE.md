...
the effects don't compose), **5** (certainty-weighted voting), **11**
...
- **220 tests** (219 `#[test]` + 1 doctest), edition 2024, 0 clippy warnings under both
